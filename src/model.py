...
class CrossDockingModel:
    ...
    def __create_parameters(self, time_unit: int) -> None:
        ...
        self.__R = self.__create_dict_from_2d_matrix(self.__data['number_of_each_product_into_inbound_loads'],
                                                  self.__products, self.__suppliers)
        self.__D = self.__create_dict_from_2d_matrix(self.__data['quantity_of_required_products_per_customer'],
        ...
        self.__TT = self.__create_dict_from_2d_matrix(self.__data['travel_time'], self.__customers, self.__customers)
        self.__CT = self.__create_dict_from_2d_matrix(self.__data['travel_time'], self.__customers, self.__customers)
    ...
    @staticmethod
    def __create_dict_from_2d_matrix(matrix: np.ndarray, label_i: List, label_j: List) -> Dict:
        """
